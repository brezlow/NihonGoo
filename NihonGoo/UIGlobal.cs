...
internal sealed class UIGlobal : AvaloniaObject
{
    ...
    public static readonly AttachedProperty<bool> TransparencyEnabledProperty =
        AvaloniaProperty.RegisterAttached<UIGlobal, Control, bool>(nameof(TransparencyEnabled), true, true);

    public static void SetTransparencyEnabled(Control obj, bool value) =>
        obj.SetValue(TransparencyEnabledProperty, value);
